...
2. `cargo workspaces version --no-git-push --allow-branch="release"`
3. run `cargo workspaces publish` on master
4. merge it back into the master with a merge request
